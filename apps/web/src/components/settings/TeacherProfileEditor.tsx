...
import { validateOptionalPhone, sanitizeProfilePhone } from '@/lib/validation-utils'
      ...
      <CardContent>
        ...
        {isProfileIncomplete && !isEditing && (
          <div className="mb-4 p-3 bg-warning-light border border-warning rounded-xl flex items-start gap-2">
            ...
            <div>
              <p className="text-warning-dark font-medium text-sm">Profile Incomplete</p>
              <p className="text-warning-dark/80 text-xs">
                Please complete your profile by adding your gender. Click &quot;Edit&quot; to update.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {isEditing ? (
              <div className="flex gap-4 mt-1" role="radiogroup" aria-label="Gender selection">
              ...
              <p className={`${gender ? 'text-text-primary capitalize' : 'text-warning-dark'}`}>
          ...
          <div>
            <label className="text-sm font-medium text-text-secondary">School Code</label>
            <p className="text-text-primary font-mono">{profile.school_code || 'Not set'}</p>
          </div>

          {/* Village */}
          <div>
            <label className="text-sm font-medium text-text-secondary">Village/Location</label>
            {isEditing ? (
              <input
                type="text"
                value={village}
