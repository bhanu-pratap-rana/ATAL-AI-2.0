      ...
      <div className="container-responsive max-w-6xl">
        ...
        <div className="grid gap-responsive">
          <Card className="card-responsive">
            ...
            <CardContent>
              <p className="text-text-secondary text-sm md:text-base mb-4">
                Learn the basics of digital literacy, including computer skills,
                internet safety, and online communication.
              </p>
          ...
          <Card className="card-responsive">
            ...
            <CardContent>
              <p className="text-text-secondary text-sm md:text-base mb-4">
                Start your coding journey with Python, HTML, CSS, and JavaScript
                fundamentals.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-primary-light text-primary-dark rounded-full text-sm">
          ...
          <Card className="bg-primary/10 border-primary/30 card-responsive">
            <CardHeader>
              <CardTitle className="text-primary-dark text-lg md:text-xl">
                Coming Soon
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-text-secondary text-sm md:text-base">
                More curriculum modules are being developed. Check back soon for
                updates!
              </p>
            </CardContent>
          </Card>
