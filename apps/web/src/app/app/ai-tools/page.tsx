    ...
    <div className="min-h-screen bg-gradient-to-br from-cream to-surface page-layout">
      <div className="container-responsive max-w-6xl">
        ...
        <div className="mb-responsive text-center sm:text-left">
          ...
          <p className="text-text-secondary text-sm md:text-base">Leverage AI-powered tools for personalized learning</p>
        </div>
        ...
        <div className="grid gap-responsive">
            ...
            <Card className="hover:shadow-lg transition-shadow card-responsive cursor-pointer hover:border-primary">
              ...
              <CardContent>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-success-light text-success-dark rounded-full text-sm">Available</span>
                </div>
              </CardContent>
            </Card>
          </Link>
          ...
          <Card className="hover:shadow-lg transition-shadow card-responsive opacity-70">
            ...
            <CardContent>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-warning-light text-warning-dark rounded-full text-sm">Coming Soon</span>
              </div>
            </CardContent>
          </Card>
