          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-6 text-center">
              ...
              <div>
                ...
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Avg Time</p>
              </div>
            </div>
          </div>
              ...
              {Object.entries(moduleStats).map(([module, stats]) => {
                ...
                return (
                  <div key={module} className="p-3 bg-slate-50 rounded-2xl text-center">
                    ...
                    <div className="text-[10px] font-bold text-slate-400">{stats.correct}/{stats.total}</div>
                  </div>
                );
              })}
            </div>
