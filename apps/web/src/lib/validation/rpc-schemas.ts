 ...
 */
export const AssessmentResponsePayloadSchema = z.object({
...
export type AssessmentResponsePayload = z.infer<typeof AssessmentResponsePayloadSchema>
 ...
 */
export const CursorPaginationItemSchema = z.object({
  id: z.string().uuid(),
 ...
 */
export function validateAssessmentResponsePayload(payload: unknown): AssessmentResponsePayload {
 ...
 * @returns Validated payload or throws ZodError
 */
export function validateMutationQueuePayload(payload: unknown): MutationQueuePayload {
 ...
 */
export function validateCursorPaginationItem(item: unknown): CursorPaginationItem {
