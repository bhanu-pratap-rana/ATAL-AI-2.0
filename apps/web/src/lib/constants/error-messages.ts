...
export const TEACHER_ERRORS = {
  ...
  CANNOT_DELETE_CLASS_WITH_STUDENTS: 'Cannot delete class with enrolled students',
 ...
 */
export function getErrorMessage(error: unknown, fallback = OPERATIONAL_ERRORS.OPERATION_FAILED): string {
