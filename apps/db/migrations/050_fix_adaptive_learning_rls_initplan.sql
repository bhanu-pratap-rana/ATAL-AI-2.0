...
--
-- Affected tables:
-- - irt_item_bank (1 policy)
-- - student_knowledge_state (4 policies)
-- - learning_style_profile (3 policies)
-- - ai_tutor_interactions (3 policies)
-- - formative_responses (3 policies)
-- - summative_results (2 policies)
-- - student_badges (2 policies)
-- - points_history (2 policies)
--
-- Also adds missing foreign key indexes.
