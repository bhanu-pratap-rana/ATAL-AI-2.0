-- Migration 075: Add user_id to assessment_responses INSERT
-- Bug: Migration 074's INSERT statement missing user_id column
-- Fix: Add p_user_id to INSERT statement
-- Impact: submit_assessment was failing because assessment_responses.user_id was missing
...
BEGIN
  ...
  -- ✅ FIXED: Add user_id column to INSERT statement
