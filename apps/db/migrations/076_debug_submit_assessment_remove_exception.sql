-- Migration 076: Temporarily remove EXCEPTION handler to debug submit_assessment
-- Purpose: Identify the exact error causing submit_assessment to fail
-- Note: This is a debug migration - we'll restore the exception handler after finding the issue
...
-- ⚠️ EXCEPTION HANDLER REMOVED FOR DEBUGGING
-- Any error will now be returned directly with full details
END;
