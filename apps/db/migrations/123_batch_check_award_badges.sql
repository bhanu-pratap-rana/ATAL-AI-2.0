...
--
-- Previous Pattern (N+1):
-- 1. Get all badges (1 query)
-- 2. For each badge, call checkCriteria() (1-10 queries each)
-- Total: 2 + (10 × 1-10) = 12-102 queries
--
-- New Pattern (Batch):
-- 1. Single RPC function checks all criteria in one transaction
-- Total: 1 query
--
-- =====================================================
...
-- =====================================================
-- SELECT * FROM batch_check_and_award_badges('student-uuid-here');
